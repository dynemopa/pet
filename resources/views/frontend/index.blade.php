...
<section class="container" id="rcorners3">
  <div id="rcorners2">
...
<div class="container">
    ...
    <div class="row">
      ...
      <a rel="tab_div1" onclick="javascript:ShowMyDiv(this);" class="btn btn-primary rs">Montgomery</a>
        

      
      <a rel="tab_div2" onclick="javascript:ShowMyDiv(this);" class="btn btn-primary rs">Birmingham</a>
